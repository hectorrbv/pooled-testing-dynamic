...
# %%
# Load training data
training_data = getAgentsFromTrainData(f'training_data_N{N}_B{B}_G{G}.csv')[:num_draws]
eval_data = getAgentsFromTrainData(f'eval_data_N{N}_B{B}_G{G}.csv')[:num_draws]
