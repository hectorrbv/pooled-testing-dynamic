...
# %%
def load_RL_model_if_exists(model, draws, epoch, beta, beta_decay, lr, save_path=f'N{N}_B{B}_G{G}_{name}/'):
    model_filename = f"{save_path}dynamic_RL_model_N{N}_B{B}_G{G}_s{draws}_e{epoch}_b{beta}_lr{lr}_bd{beta_decay}.pth"
