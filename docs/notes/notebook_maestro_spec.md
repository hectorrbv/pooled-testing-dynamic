...
Un solo notebook que recapitule el proyecto de **Dynamic Augmented Grouped
Counting** para una sesión con Francisco Marmolejo, cubriendo 6 pedidos:

1. Ejemplos de **cómo sabemos que Gibbs funciona**.
2. **Perfiles de estado latente con mayor separación** (3 nociones).
