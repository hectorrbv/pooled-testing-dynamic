...
Desenlaces posibles sin apostar: casi todo adaptación / casi todo conteo / complementariedad / por régimen. Contexto (no predicción): el paper hermano prueba que con $q<1/2$ el pooling binario no paga *en la celda estática*. Sesión 2026-09-01: la versión dinámica (singletons óptimos en no-aumentado si $q_{sano}\le1/2$) fue enunciada por Francisco, condicionada a su prueba escrita [40:16–41:07]. Empírico: DP exacto, simetría, políticas extraídas. Teórico: reemplazo pool→singleton *considerando continuación*; vigilar: rama cero de pool grande, positivas que cambian asignación, agotamiento finito, deducciones por traslape. Fallback: cota + limitación + separación conjunta (C4). **Nota (sesión 2026-08-25):** Thm 7.1 del companion afirma exactamente esta celda para $q_i\le 1/2$ — óptimo binario adaptativo = top-$\min\{B,n\}$ singletons por $q_iu_i$, no-adaptativo [SIN VALIDAR → A-M23]. El lado $q>1/2$ (la mitad disputada de C1) sigue abierto.
...
6. **Barrera computacional:** ¿existe un algoritmo de optimización dinámica eficiente sobre el espacio laminar, o hay una dureza fundamental que lo impida? Formulación pedida en la sesión 2026-08-18 [22:37–23:21] como enunciado central del documento formal (A-M22). No sustituye a las preguntas 1–5: las enmarca — una barrera de dureza sería un resultado tan publicable como una garantía. Piso conocido: elegir un solo test estático óptimo ya es W[1]-duro en $G$ (companion Prop 6.1, citando [1]); en sesión: "es muy fácil demostrar que es como difícil hacer el cómputo óptimo" [2026-08-25, 07:24–07:49]. Capa añadida (sesión 2026-09-01): además de eficiente-vs-óptimo-laminar, la comparación laminar-vs-óptimo-dinámico-irrestricto a factor constante [46:24–47:15].
...
| 2026-09-01 | **Territorios (propuesta, pendiente de acuerdo explícito el 15-sep): el dinámico no-aumentado (factor 2 de adaptabilidad vía muestreo del prior, thinning 50% y coupling perfil/antiperfil; greedy estático a factor constante; singletons óptimos si $q_{sano}\le 1/2$) va al paper de Nick reescrito; el aumentado laminar posterior-zero (modelo, Bellman exacto, brecha de convención, separación, portafolio de políticas) es del equipo.** Ningún resultado no-aumentado se compromete como nuestro | sesión 2026-09-01 [04:18–06:46] (reescritura del paper de Nick, envío previsto 14-sep), [37:04–38:15] ("creo que este argumento no va a funcionar así en nuestro caso"; "de nada te sirve tener augmented si no es dinámico") | seguir sin reparto (riesgo de duplicación, fila 2026-08-25); reclamar piezas no-aumentadas (contradice lo dicho en sesión) | A-M19/A-M22 escriben solo bajo nuestro modelo; §34 (19) pasa a PARCIAL; §0-bis (a) anota el territorio | al recibir el paper de Nick reescrito y la respuesta a (19) |
| 2026-09-01 | **Resultado soñado como norte de la cadena teórica, en dos capas:** (i) laminar dentro de un factor constante del óptimo dinámico irrestricto; (ii) dentro del espacio laminar, un algoritmo eficiente aproximadamente óptimo ("greedy con hard clearing, soft clearing o alguna regla"). (ii) es la Conjetura 10.7 del companion; (i) hoy solo existe como factor $G$ (Thm 8.2) | sesión 2026-09-01 [46:24–47:15] ("en un mundo perfecto, un resultado padrísimo sería..."; "tenemos tiempo para hacerlo") | tomar (i) o (ii) como compromiso fechado (no lo son: "va a estar difícil") | confirma espina (§0-bis a); §34 (1) y (4) actualizadas; §20 pregunta 6 gana la capa (i) como nota; A-M23/A-M19 apuntan a (i)+(ii); ningún milestone ni gate nuevo | tras A-M23 (§8–§10) |
| 2026-09-01 | **Encargo: análisis empírico de varios greedy en el régimen de separación; buscar una población donde a todos les vaya mal; "corre tres greedy y toma el mejor" como candidato a algoritmo eficiente con factor.** Se procesa en B-M11 (adversaria dirigida) y B-M17 ($J^\pi_b$). **Estado: CUMPLIDO por B 1–9 sep con sobre-entrega:** contraejemplo universal $n{=}6$, $B{=}3$, $G{=}4$ heterogéneo, $\pi_M/\pi_C/\pi_R$/C3 a 0.6576 del óptimo; $\pi_L$ ($I_\lambda$, ec. 8.13) lo rescata a 0.9641; portafolio best-of-5 $\alpha\approx0.9307$ en ~7,000 instancias ($n\le8$, $G\le4$, $B\le5$) sin contraejemplo; $\lambda$ es parte de la especificación (rejilla gruesa: 0.794). Estatuto: hallazgo diagnóstico [VERIFICADO n≤8]; no es garantía | sesión 2026-09-01 [48:10–49:53]; commits 50eb431, 3bb9415, c3070ee, 5889672, db9712c; notas `2026-09-01-contraejemplo-universal-greedy.md`, `2026-09-02-constante-empirica-portafolio.md` | abrir misión nueva de contraejemplos (la evidencia diagnóstica ya existe); presentar $\alpha$ como constante demostrada (viola §25) | §34 gana (24) regla de $\lambda$; las cifras entran a §9 por la higiene de claims de B (fuera de este despacho); el score S3/G4a se diseña después de la Proposición de brecha (plan 11-sep) | al cerrar la regla de $\lambda$ o al aparecer un contraejemplo del portafolio |
| 2026-09-01 | **Dinámico no-aumentado con $q_{sano}\le1/2$: singletons óptimos** (dicho en sesión como "probabilidad de infección menor a 0.5"; lectura consistente con Prop 1 de v4, Thm 7.1 del companion y la sesión del 25-ago; cotejo de A contra el PDF pendiente). Cierra el lado no-aumentado del ejemplo de separación ("más allá de un factor de 2"), condicionado a la prueba escrita. Thm 3 de v4 (W[1] en $G$) queda citable tras el cotejo | sesión 2026-09-01 [40:16–41:07]; nota C-M1 `2026-09-01-revision-update-2206.10660-v4.md` | actualizar C4/§18 ya (viola §25 hasta el cotejo) | §34 (15) RESPONDIDA condicionada al cotejo; (12) PARCIAL; §18 gana nota; la cuarentena de C1 (fila 2026-08-02) se resuelve por la higiene gana/empata/pierde de la revisión del 5-sep, no por esta fila | al cotejar A el PDF v4 y al recibir la prueba escrita |
| 2026-09-01 | **La brecha de convención se declara a Francisco y se recibe con interés ("Qué interesante"):** bajo estricta el óptimo nunca agrupa ($3/5=0.60$) y bajo posterior-zero abre el par ($387/500=0.774$) en $n{=}4$, $q_{sano}{=}0.3$, $B{=}2$, $G{=}2$ [VERIFICADO dos vías]. La pieza nombrable (1) de A (fila 2026-08-30) se confirma como base: **Proposición de brecha de convención en tres partes** (dominación · simulación con sobrecosto · agudeza), primer resultado propio de A-M22. Las cifras habladas en sesión (0.12, ~0.75) no coinciden con las verificadas y no se citan | sesión 2026-09-01 [41:07–45:19]; adenda del guion 1-sep; `2026-08-31-ratificacion-G0-cuentas-B.md` | dejar la brecha como observación numérica (deja el paper sin resultado propio) | A-M22 anota la Proposición; el guion del 15-sep corrige las cifras habladas; corolario a presentar: la región $q_{sano}\le1/2$ de [v4, Prop 1] no existe bajo conteos aumentados con posterior-zero (testigo $B{=}2$, todo $q$) | al cerrar la Proposición con etiqueta §25 |
| 2026-09-01 | **Francisco enviará su prueba escrita (factor 2 y greedy) para revisión del equipo.** El equipo la revisa al recibirla; A llega con una reconstrucción propia del argumento (una página, extra del mantra) y con la pregunta (23) sobre dónde se rompe en aumentado | sesión 2026-09-01 [49:58–50:11] ("si ven algún error, también que nos digan") | esperar la prueba sin reconstrucción (revisión pasiva) | compromiso externo en §34-bis; A-M18 gana la revisión de esa prueba; §34 (23) nueva | al recibir la prueba |
...
**Compromisos fechados externos vigentes:** reformulación de la Conjetura C (P21-A8). [Cumplido 2026-08-11: derivación + confirmación computacional de $V(T)=E_R[B(R)]$ en el ejemplo motivador — ver §32.] [Actualizado 2026-08-18: el cotejo del teorema estático $p>1/2$ pasa al equipo (§21, §32).] **De Francisco (sesión 2026-09-01):** prueba escrita del factor 2 y del greedy, para revisión del equipo [49:58–50:11] · paper de Nick reescrito, envío previsto 14-sep [04:18–05:05] · nueva hora de sesión cuando el equipo esté en Praga [03:33–04:18]. **Siguen del 25-ago:** un ejemplo propio de la falla del presupuesto-infinito [12:03] · lectura a fondo de §8+ del companion [48:30–49:55, 51:17]. **Del equipo (sesión 2026-09-01):** análisis empírico de greedies, contraejemplo y portafolio [48:10–49:53] — **CUMPLIDO por B 1–9 sep** (fila §32 2026-09-01) · Lema A cerrado [45:39] — pendiente · `tests_bm17.py` (dos vías) — pendiente · revisión de la prueba de Francisco al recibirla, con reconstrucción previa de A. **Siguen vigentes:** documento formal laminar (A-M22, con la Proposición de brecha de convención) · outline SODA (A-M19) · validación del companion (A-M23) · migración de convención (A-M24/B-M18; G0 cerrado 2026-08-31) · re-medición de $C(T)$ con greedy local post-prueba (B-M6) · barrido diagnóstico $V/C^\alpha$ (adopción vía B-M9 tras G4a) · cotejo del PDF v4 (A, C-M1).
