...
**Del 20 al 24 de agosto (5 días hasta la sesión del 25-ago; asignación de esfuerzo, no fechas de teoremas) — reescrita tras el despacho de la sesión del 2026-08-18:**

*Estado heredado:* cadena B cerrada hasta B-M8 (G1 y G5 aprobados; falsificador operando); notebook 25 con el valor realizable exacto (§7) y la degeneración del costo-greedy global (§8), cuya corrección — greedy local post-prueba — es directriz de la sesión. Cadena A: A-M11 cumplido y validado en sesión; A-M12 en curso; A-M5–A-M9 (Lema A) desplazados una semana por los encargos de escritura (D8–D9 del acta 2026-08-18).

| Día | A | B | Soporte IA |
|---|---|---|---|
| 1 (jue 20) | A-M22: esqueleto del documento formal laminar (modelo, espacio laminar, contraejemplo de no-reentrada, pregunta algoritmo-vs-barrera) | B-M6 (ext.): re-medición de $C(T)$ con greedy local post-prueba (§32 2026-08-18); regenerar §8 del notebook 25 | C-M1: paper de arXiv — enunciado e hipótesis del teorema estático $p>1/2$ (pregunta 15); A valida antes de tocar C1 · revisión knapsack auctions (adenda post-sesión; nota iniciada) |
| 2 (vie 21) | A-M19: outline del paper en documento nuevo · A-M21: prueba de dominación de la repetición idéntica | B-M16: artefacto del contraejemplo de no-reentrada (0.5 / 0.6 / retest, con semilla y CSV) | árbitro del esqueleto A-M22 |
| 3 (sáb 22) | A-M12: cierre del diseño de $\varphi$ con el menú valor-por-presupuesto como marco (D3 del acta) | **Barrido diagnóstico** $V/C^\alpha$ ($\alpha\in\{1/2,1,3/2\}$, filtro $C\le b$) sobre la matriz 23.1 — no es selección de candidata | C-M3: harness del barrido $\alpha$ |
| 4 (dom 23) | A-M13: **G4a — acid test analítico, en papel** | Si G4a aprueba → B-M9 formal (incluye candidata F); si no → iterar diseño con A | lupa |
| 5 (lun 24) | A-M20: guion de sesión + revisión cruzada | Revisión cruzada | lupa del paquete |
...
1. (B) B-M16 con números **exactos** por enumeración ($n{=}4$): el contraejemplo de no-reentrada con procedencia — alimenta directo A-M22.
2. (B) Re-correr la preocupación $q{=}0.7$ (notebook 25 §9) bajo el costo local nuevo — responde una duda que quedó abierta en sesión.
3. (A, IA de árbitro) Pregunta (9): $C(T)$ exacta con $u\equiv1$ en grupos chicos bajo la medición local (esperanza por enumeración sobre $R$); si aparece patrón, conjetura **etiquetada** (§25).
4. (B) La variante de alcance de la pregunta (16) como flag del barrido ($T$ solo vs. $T\,\cup$ átomos abiertos) — llegar con datos, no solo con la pregunta.
5. (A) El PDF de problema concreto **terminado**, no solo esqueleto — el "siguiente paso" que Francisco mismo propuso como opcional (D8 del acta).
6. (IA) Cierre de la auditoría de C1 (trazas $p>0.5$ + teorema del arXiv) si el paper llega a tiempo — levanta la cuarentena de la fila 2026-08-02.
7. (IA) Una página de vecinos: stochastic/adaptive knapsack (Dean–Goemans–Vondrák) como puente al caso adaptativo.
...
**Compromisos fechados externos vigentes:** reformulación de la Conjetura C (P21-A8). [Cumplido 2026-08-11: derivación + confirmación computacional de $V(T)=E_R[B(R)]$ en el ejemplo motivador — ver §32.] [Actualizado 2026-08-18: el cotejo del teorema estático $p>1/2$ deja de ser compromiso de Francisco — el paper hermano está en arXiv; el cotejo pasa al equipo (§21, §32).] **Compromisos del equipo fechados en la sesión 2026-08-18:** documento formal laminar (A-M22) · outline del paper en documento nuevo (A-M19) · re-medición de $C(T)$ con greedy local post-prueba (B-M6) · barrido diagnóstico de la familia $V/C^\alpha$ (estatuto diagnóstico; adopción vía B-M9 tras G4a).
