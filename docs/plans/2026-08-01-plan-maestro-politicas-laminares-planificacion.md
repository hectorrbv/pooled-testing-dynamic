...
**Compromisos fechados externos vigentes:** reformulación de la Conjetura C (P21-A8) · derivación + confirmación computacional de $V(T)=E_R[B(R)]$ en el ejemplo motivador, próxima sesión (origen: sesión 2026-08-02) · Francisco: cotejo del teorema estático $p>1/2$ en el paper.
