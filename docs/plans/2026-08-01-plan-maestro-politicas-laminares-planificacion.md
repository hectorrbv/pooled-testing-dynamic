...
**Compromisos fechados externos vigentes:** reformulación de la Conjetura C (P21-A8). [Cumplido 2026-08-11: derivación + confirmación computacional de $V(T)=E_R[B(R)]$ en el ejemplo motivador — ver §32.] [Actualizado 2026-08-18: el cotejo del teorema estático $p>1/2$ pasa al equipo (§21, §32).] **De Francisco (sesión 2026-08-25):** compartir el update del paper de Nick y el reparto de resultados [06:51–07:24] · un ejemplo propio de la falla del presupuesto-infinito [12:03] · lectura a fondo de §8+ del companion [48:30–49:55, 51:17] · mensaje con nueva hora de sesión (clases mar/jue desde la semana del 31-ago) [52:40–52:52]. **Del equipo (sesión 2026-08-25):** checar el companion completo (A-M23) · implementar Bellman y cotejar en el ejemplo chico (B-M17) · migración de convención tras G0 (A-M24/B-M18; **G0 cerrado 2026-08-31 con la ratificación de B**). **Siguen vigentes (2026-08-18):** documento formal laminar (A-M22) · outline del paper (A-M19, ahora formato SODA) · re-medición de $C(T)$ con greedy local post-prueba (B-M6) · barrido diagnóstico $V/C^\alpha$ (adopción vía B-M9 tras G4a).
