...
**Del 31 de agosto al 4 de septiembre (hasta la nueva hora de sesión — Francisco enviará mensaje; asignación de esfuerzo, no fechas de teoremas) — reescrita tras el despacho de la sesión del 2026-08-25:**

*Estado heredado:* despacho del 25-ago aplicado el 30-ago (G0 → posterior-zero, aprobado por A; **ratificación de B pendiente: primer punto de la semana**). Cadena B cerrada hasta B-M8 (G1 y G5 aprobados; falsificador operando); estado de la semana 20–24 (B-M6 ext., barrido $\alpha$, B-M16) por confirmar con B. Cadena A: el cálculo completo re-hecho la semana pasada, **la escritura sin iniciar — es la base 1**; el cálculo re-hecho se migra a posterior-zero antes de fijar números (A-M24). Francisco toma la lectura de §8+ del companion.

| Día | A | B | Soporte IA |
|---|---|---|---|
| 1 (lun 31) | Ratificar G0 con B · A-M24: texto §5 + inventario cerrado de impacto | Ratificar G0 · B-M17: diseño (estado canónico, comparador pathwise) | C-M2: árbitro del inventario A-M24 · nota Harris (§21) |
| 2 (mar 1) | A-M22: **escritura** del esqueleto bajo posterior-zero, migrando el cálculo re-hecho | B-M17: recursión 5.5 + memoización + normalizador ν | harness de cotejo: enumerador pathwise chico |
| 3 (mié 2) | A-M22 cont. · arranque A-M23: Thm 8.2 + Cor 8.3 (salvaguarda) | B-M17: validación dos vías ($n\le5$, $B\le3$) + ancla §16 re-derivada | lupa adversarial de §8 del companion (lista de gaps para A) |
| 4 (jue 3) | A-M19: outline en formato SODA | B-M18: migración mínima (B-M16 re-derivado bajo posterior-zero; assertions) | C-M1: cotejo del teorema $p>1/2$ (cuarentena C1) |
| 5 (vie 4) | A-M13: **G4a re-planteado bajo posterior-zero** ($k{=}3$) | Barrido $\alpha$ re-corrido bajo convención nueva (si B-M18 llegó) | A-M20: guion + paquete, arranque |
...
2. (B) Mapas homogéneos chicos post-B-M17 (Phase 3 del companion) — diagnóstico exacto, no es el atlas de §23.4.
3. (B) Columna de salvaguarda singleton (Cor 8.3) en el harness — garantía $1/G$ gratis por candidata.
4. (A+B) Respuesta anticipada a la pregunta (21): costo del test acreditador medido en ambas convenciones sobre el ancla.
5. (IA) Nota $I_\lambda$ (companion 8.13) como candidata G: qué mide, qué cota da, cómo se calibraría sin violar §31.

(Los extras no cobrados de la semana pasada — $q{=}0.7$ bajo costo local, pregunta (9), flag de alcance (16), vecinos Dean–Goemans–Vondrák — siguen en el pozo, después de estos.)
