# Augmented Group Counting Guide Implementation Design

Date: 2026-03-09
Source: "Guide for Augmented Group Counting" (Francisco's meeting prep)

## Overview

Six improvements to the DAPTS codebase based on Francisco's feedback.

## Item 1: Preprocessing — Exclude cleared/confirmed-active from pools
...
- Track `confirmed_active_mask` when p_i approaches 1 after Bayesian updates
...
- Enumerate all 2^n latent-state profiles
...
- Focus on high latent-state rate regimes (Francisco's hypothesis)
