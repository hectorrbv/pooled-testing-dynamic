# Design: Five Follow-Up Items for Augmented Adaptive Group Counting
...
## Item 3: High LatentState Rate Experiments at Scale

500+ instances, p in [0.3, 0.8], n in {5,8,10}, B in {2,3}.
Confirm Francisco's hypothesis that augmented benefit grows with latent-state rate.

## Item 4: Cross-Verification with Nick's Code

Export synthetic instances as JSON for `nrlopez03/group-count`.
